...
const goose = ['../the \goose/please.png', '../the \goose/no.png','../the \goose/punch.png','../the \goose/knife.png', '../the \goose/dead.png','../the \goose/loss.png','../the \goose/pathetic.jpg','../the \goose/lata.png']
let imgi = 0
...
function nestJS() {
    var c = document.getElementById('barred').value,
        url = '../page\ 2\ prototype/page3.html?name=' + encodeURIComponent(c);
